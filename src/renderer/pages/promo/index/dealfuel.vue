      ...
      <div class="w-full md:w-7/12">
        ...
        <div>
          <h1 class="font-medium text-[48px] leading-[58px] text-primary">
            Redeem your DealFuel Code for Locker's Package
          </h1>

          <p class="font-semibold text-[20px] mb-4 mt-4">
            {{ $t('lifetime.redeem_page.intro.desc', { service: 'DealFuel' }) }}
          </p>
          <ol class="list-decimal ml-4 mb-4">
            ...
            >
              {{
                item.replaceAll
                  ? item.replaceAll('{service}', 'DealFuel')
                  : item
              }}
            </li>
          </ol>
        ...
        <!-- Form -->
        <RedeemForm :countries="countries" service="DealFuel" />
        <!-- Form end -->
      </div>
      <!-- Left end -->
