  ...
  <div>
    ...
    >
      ...
      <div class="setting-section">
        ...
        <div class="setting-description mb-6">{{ $t('data.family_member.list_member_title') }}</div>
          ...
          <template v-for="(member, index) in familyMembers">
            ...
            >
              <div class="flex items-center">
                ...
                <div>
                  <div class="text-sm font-semibold" :class="member.id?'':'text-primary'">
                    <nobr v-if="member.full_name">
                      {{ member.full_name }} {{ currentUser.email === member.email?` (${$t('common.you')})`:'' }}
                    </nobr>
                    <nobr v-else>
                      ...
                      <el-tooltip placement="right" effect="light">
                        ...
                        >
                          <path d="M10 17.5C14.1421 17.5 17.5 14.1421 17.5 10C17.5 5.85786 14.1421 2.5 10 2.5C5.85786 2.5 2.5 5.85786 2.5 10C2.5 14.1421 5.85786 17.5 10 17.5Z" stroke="#072245" stroke-width="1.32739" stroke-linecap="round" stroke-linejoin="round" />
                          <path d="M10.896 14.0625C10.896 14.5574 10.4949 14.9585 10 14.9585C9.50514 14.9585 9.10398 14.5574 9.10398 14.0625C9.10398 13.5676 9.50514 13.1665 10 13.1665C10.4949 13.1665 10.896 13.5676 10.896 14.0625Z" fill="black" stroke="#072245" stroke-width="0.082962" />
                          <path d="M10 11.25V10.625C10.4326 10.625 10.8556 10.4967 11.2153 10.2563C11.575 10.016 11.8554 9.67433 12.021 9.27462C12.1866 8.87491 12.2299 8.43507 12.1455 8.01074C12.0611 7.58641 11.8527 7.19663 11.5468 6.89071C11.2409 6.58478 10.8511 6.37644 10.4268 6.29203C10.0024 6.20763 9.56259 6.25095 9.16288 6.41651C8.76317 6.58208 8.42153 6.86246 8.18116 7.22219C7.94079 7.58192 7.8125 8.00485 7.8125 8.4375" stroke="#072245" stroke-width="1.32739" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                      </el-tooltip>
                    </nobr>
                  </div>
