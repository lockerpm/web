<template>
  <div>
    <section
      class="bg-welcome full-width h-auto pt-[76px] bg-center bg-cover bg-no-repeat"
      :style="{
        backgroundImage: `url(${require(`~/assets/images/landing/crypto/bg-frame.png`)})`
      }"
    >
      ...
      <div class="w-full text-center">
        ...
        <div class="max-w-6xl mx-auto">
          <div class="grid grid-cols-3 gap-x-16 justify-items-center">
            ...
            >
              <img
                :src="require(`~/assets/images/landing/crypto/${item.image}`)"
                class="h-[51px] mb-5"
              >
            </div>
            <div
          ...
          <div>
            <div
              v-for="(item, index) in $t(
                'crypto.sale_pitch.common_reason.reason'
              )"
              :key="index"
              class="items-center"
            >
              <div class="flex max-w-[560px] mb-[52px]">
                <img
                  :src="require(`~/assets/images/landing/crypto/XCircle.svg`)"
                  class="h-[32px] mr-[10px]"
                >
      ...
      <div class="max-w-6xl mx-auto mt-16">
        <div class="flex justify-between">
          <div>
            ...
            <div
              v-if="locale === 'en'"
              class="font-normal landing-font-18 max-w-[640px] mb-20"
            >
          ...
          <div class="max-w-[710px]">
            ...
            >
              <div class="flex max-w-[670px] mb-[50px]">
                <img
                  :src="
                    require(`~/assets/images/landing/crypto/CheckCircle.svg`)
                  "
                  class="h-[32px] mr-[10px]"
                >
                <div class="landing-font-18 font-normal">
    ...
    <section class="items-introduce-crypto py-[120px]">
      <div
        v-for="(item, index) in $t('crypto.introduce_crypto.items')"
        :key="index"
        class="grid md:grid-cols-2 grid-cols-1 items-center"
        :class="
          index === 1
            ? 'my-[100px] md:gap-x-[120px] gap-y-[60px]'
            : 'md:gap-x-[40px] gap-y-[60px]'
        "
      >
        <div
          :class="index === 1 ? '!order-last' : ''"
          class="md:order-first order-last"
        >
          <div class="font-bold landing-font-38 text-[#161922] mb-5">
            {{ item.title }}
          </div>
          <div class="text-[#5A6176] landing-font-18 font-normal mb-[40px]">
            {{ item.desc }}
          </div>
          <div>
            <a
        ...
        <div>
          <img
            v-if="locale === 'en'"
            :src="require(`~/assets/images/landing/crypto/en/${item.img}`)"
            alt=""
          >
          <img
            v-else
            :src="require(`~/assets/images/landing/crypto/vi/${item.img}`)"
            alt=""
          >
        </div>
      </div>
    </section>
    <section class="system-security py-[120px]">
      <div class="font-bold text-[#161922] landing-font-38 mb-6 text-center">
        {{ $t('crypto.security_system.title') }}
      </div>
      <div
        class="font-normal landing-font-22 text-[#000000] mb-[100px] text-center"
      >
        {{ $t('crypto.security_system.desc') }}
      </div>
      <div
        class="grid md:grid-cols-3 grid-cols-1 md:grid-flow-col items-center gap-x-[28px]"
      >
        <div class="order-0 grid gap-y-[83px]">
          <div
            v-for="(item, index) in $t(
              'crypto.security_system.list_item_services.left'
            )"
            :key="index"
            class="items-center"
          >
            <div class="flex">
              <div>
                <img
                  :src="
                    require(`~/assets/images/landing/crypto/${item.icon_1}`)
                  "
                  class="icon-sys"
                >
              </div>
              <div class="font-normal landing-font-16 text-[#000000] ml-3">
                {{ item.desc }}
              </div>
            </div>
          </div>
        </div>
        <div class="md:order-1 order-first">
          <div
            class="grid md:grid-rows-4 grid-rows-1 md:gap-y-[35px] gap-y-[60px]"
          >
            <div class="grid md:grid-cols-3 grid-rows-1">
              <div class="md:block hidden">
                <img src="~/assets/images/landing/crypto/icon_left_top.png">
              </div>
              <div class="md:block hidden" />
              <div class="md:block hidden">
                <img src="~/assets/images/landing/crypto/icon_right_top.png">
              </div>
            </div>
            <div
              class="grid md:grid-cols-6 grid-cols-1 items-center row-span-3"
            >
              <div class="md:block hidden">
                <img src="~/assets/images/landing/crypto/icon_line_left.png">
              </div>
              <div class="col-span-4">
                <img src="~/assets/images/landing/crypto/icon_center.png">
              </div>
              <div class="md:block hidden">
                <img src="~/assets/images/landing/crypto/icon_line_right.png">
              </div>
            </div>
            <div class="grid md:grid-cols-3 grid-cols-1">
              <div class="md:block hidden">
                <img
                  src="~/assets/images/landing/crypto/icon_left_bottom.png"
                >
              </div>
              <div class="md:block hidden" />
              <div class="md:block hidden">
                <img
                  src="~/assets/images/landing/crypto/icon_right_bottom.png"
                >
              </div>
            </div>
          </div>
        </div>
        <div class="grid order-2 md:gap-y-[135px] gap-y-[60px]">
          <div
            v-for="(item, index) in $t(
              'crypto.security_system.list_item_services.right'
            )"
            :key="item.icon_1.toString()"
            class="items-center"
            :class="index === 0 ? 'md:mt-0 mt-[60px]' : ''"
          >
            <div class="flex">
              <div>
                <img
    ...
    <section class="locker-start py-[120px] full-width h-auto bg-[#F8F9FA]">
      <div class="max-w-6xl mx-auto px-6">
        <div
          class="landing-font-38 font-bold text-[#161922] text-center mb-[72px]"
        >
          {{ $t('crypto.locker_start.title') }}
        </div>
        <div class="process-tab">
          <div class="text-center menu-tab-menu" style="margin-bottom: 88px">
            <el-radio-group v-model="tabPosition">
              <el-radio-button
                v-for="(item, index) in $t('crypto.locker_start.list_tabs')"
                :key="index"
              ...
              >
                <template>
                  <div
                    class="font-semibold landing-font-20 text-center uppercase"
                  >
                    {{ item.tab_name }}
                  </div>
                </template>
          ...
          <div
            v-show="tabPosition"
            class="grid md:grid-cols-2 grid-cols-1 md:gap-x-[130px] gap-y-[60px]"
          >
            <div v-if="tabPosition === currentPosition" class="w-4/5 m-auto">
              <img
                v-if="locale === 'en'"
                :src="
                  require(`~/assets/images/landing/crypto/en/${
                    $t('crypto.locker_start.list_tabs')[Number(tabPosition)]
                      .list_process[Number(indexImage)].img
                  }`)
                "
                class="w-[70%] m-auto"
              >
              <img
                v-else
                :src="
                  require(`~/assets/images/landing/crypto/vi/${
                    $t('crypto.locker_start.list_tabs')[Number(tabPosition)]
                      .list_process[Number(indexImage)].img
                  }`)
                "
            ...
            <div>
              <div
                v-for="(item, idx) in $t('crypto.locker_start.list_tabs')[
                  Number(tabPosition)
                ].list_process"
                :key="idx"
                class=""
              >
                <div>
                  <div v-if="currentPosition === tabPosition" class="flex">
                    <div
                      :class="
                        idx.toString() === indexImage
                          ? 'text-[#FFFFFF]'
                          : 'text-[#979797]'
                      "
                      @click="displayImage(idx)"
                    >
                      <span
                        class="index-image bg-[#DFDFDF] landing-font-16 py-2 px-[15px] h-[42px]"
                        style="border-radius: 50%"
                        :style="
                          idx.toString() === indexImage
                            ? ' background-image: radial-gradient(#268334 55%, #D9EADC 45%);'
                            : 'background:#DFDFDF'
                        "
                      >
                        {{ idx + 1 }}
                      ...
                      <div
                        v-if="
                          idx + 1 <
                            $t('crypto.locker_start.list_tabs')[
                              Number(tabPosition)
                            ].list_process.length
                        "
                        :class="
                    ...
                    <div class="ml-4">
                      <div
                        class="landing-font-18 font-semibold"
                        :class="
                          idx.toString() === indexImage
                            ? 'text-[#268334]'
                            : 'text-[#979797]'
                      ...
                      <div v-if="item.detail !== ''" class="mt-2">
                        <div
                          v-for="(sub_item, i) in item.detail"
                          :key="i.toString() + sub_item"
                          class="mb-1 flex"
                          :class="
                            idx.toString() === indexImage
                              ? 'text-[#268334]'
                        ...
                        >
                          <div
                            ...
                            "
                          />
                          <div class="landing-font-14 font-normal ml-2">
                            {{ sub_item }}
                          </div>
                        </div>
                      </div>
                  ...
                  <div v-else class="flex" @change="indexImage = '0'">
                    <div
                      :class="idx === 0 ? 'text-[#FFFFFF]' : 'text-[#979797]'"
                      @click="displayImage(idx)"
                    >
                      <span
                        class="index-image landing-font-16 py-2 px-[15px] h-[42px]"
                        style="border-radius: 50%"
                        :style="
                          idx === 0
                            ? ' background-image: radial-gradient(#268334 55%, #D9EADC 45%);'
                    ...
                    <div class="ml-4">
                      <div
                        class="landing-font-18 font-semibold"
                        :class="idx === 0 ? 'text-[#268334]' : 'text-[#979797]'"
                      >
                        {{ item.name_item }}
                      </div>
                      <div v-if="item.detail !== ''" class="mt-2">
    ...
    <section class="guarantee py-[100px] full-width h-auto">
      ...
      <div class="mt-10">
        <div class="flex justify-center">
          ...
          >
            <img
              :src="require(`~/assets/images/landing/crypto/${item}`)"
              class="h-[28px]"
            >
          </div>
        </div>
      ...
      <div class="flex justify-center items-center mt-[60px]">
        ...
        >
          <div class="flex justify-center items-center px-[29px]">
            <img
              :src="require(`~/assets/images/landing/crypto/ShoppingCart.svg`)"
              class="h-[32px] mr-3"
            >
    ...
    <section class="final-pitch full-width py-[90px]">
      <div
        class="max-w-6xl h-[320px] flex justify-center items-center mx-auto bg-center bg-cover bg-no-repeat"
        :style="{
          backgroundImage: `url(${require(`~/assets/images/landing/crypto/final-pitch.png`)})`
        }"
      >
        <div class="px-[130px]">
          ...
          <div class="landing-font-32 font-bold text-center text-white">
            <a href="https://buy.stripe.com/cN26s3gbefi1c92fYZ">
...
export default {
  ...
  methods: {
    displayImage (idx) {
      this.currentPosition = this.tabPosition
      this.indexImage = idx.toString()
    }
  }
}
</script>
...
.locker-start .process-tab .menu-tab-menu .el-radio-button__orig-radio {
  border-radius: 50px;
  border: none !important;
  background: rgba(0, 0, 0, 0.04);
  box-shadow: none !important;
