<template>
  <div v-loading="loading.all" class="flex flex-grow flex-col">
    <!-- Content -->
    <div class="w-full max-w-9xl mx-auto px-6 py-12">
      <div class="mb-12">
      ...
      <div class="flex flex-wrap">
        ...
        >
          ...
          <div class="mb-8">
            ...
            <div class="flex justify-between mb-3">
              ...
              <p class="text-right">
                {{ selectedPeriod.value }} {{ selectedPeriod.duration }}
              </p>
            </div>
        ...
        <!-- Right -->
        <div class="w-full md:w-5/12 rounded border border-black-50 p-8">
          <!-- Need create account? -->
    ...
    calcPrice: debounce(function () {
      ...
      this.$axios
        .$post(url, {
          ...
          plan_duration: this.selectedPlanDuration,
