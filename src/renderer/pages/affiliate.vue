<template>
  <div>
    ...
    >
      <div class="md:pt-[140px] pt-28 mx-auto pl-6">
        <div class="w-full flex flex-wrap justify-end">
          <div
            class="lg:max-w-[610px] max-h-[500px] md:w-1/2 order-1 mb-8 md:mb-0 z-10"
          >
            <h1
              class="text-left font-bold text-black landing-font-50 md:whitespace-nowrap whitespace-normal"
            >
          ...
          <!-- Right -->
          <div
            class="hidden md:block md:w-[48%] order-2 justify-self-end top-[173px] pr-0"
          >
            <img
              :src="
    ...
    <section class="py-[120px]">
      <div class="w-full">
        <h2
          class="w-full font-bold landing-font-48 text-black text-center mb-6"
        >
        ...
        >
        <div
          class="mt-16 grid md:grid-cols-2 grid-cols-1 md:gap-x-20 gap-x-0 gap-y-12"
        >
          <div
          ...
          >
            <img
              :src="require(`~/assets/images/landing/affiliate/${item.icon}`)"
            >
    ...
    <section class="py-[120px]">
      <div class="w-full">
        ...
        <div class="mt-16 grid md:grid-cols-8 grid-cols-1">
          <template
            v-for="(item, index) in $t('landing_affiliate.steps.details')"
          >
            <div :key="index" class="col-span-2">
              <div
                class="w-full text-right text-[#62AD56] text-[85px] leading-[104px] font-bold opacity-[33%]"
              >
                0{{ index + 1 }}
              </div>
              <img
              ...
              <div
                class="landing-font-16 mt-8 text-black font-normal text-center"
              >
                {{ item.desc }}
              </div>
            ...
            <div
              v-if="index !== 2"
              :key="`arrow-r-${index}`"
              class="md:col-span-1 md:block hidden self-center"
            >
              <img
                src="~/assets/images/landing/affiliate/arrow.svg"
                class="mx-auto"
              >
            </div>
            <div
              v-if="index !== 2"
              :key="`arrow-${index}`"
              class="w-full h-6 md:hidden block mt-4"
            >
              <img
    ...
    <section class="py-[120px] full-width h-auto questions">
      ...
      <div class="max-w-6xl px-6 mx-auto">
        <el-collapse v-model="activeName" accordion>
          <el-collapse-item
            v-for="(item, index) in $t('landing_affiliate.faqs.details')"
            :key="index"
    ...
    <div class="mb-[90px] py-6 px-8 bg-[#E8E8E9] flex gap-x-6 rounded">
      ...
      <div class="font-semibold max-w-4/5 overflow-hidden overflow-ellipsis">
        ...
        <div class="landing-font-16">
          {{ $t('landing_affiliate.help_box.detail') }}
          <span><a :href="`mailto:${$t('landing_affiliate.help_box.email')}`">{{
            $t('landing_affiliate.help_box.email')
          }}</a></span>
        </div>
      </div>
    </div>
    ...
    >
      ...
      <template v-else>
        <div class="text-center py-10">
          <div class="mt-2 text-head-6">
            {{ $t('landing_affiliate.thankyou') }}
          </div>
          <div class="mt-[30px]">
            <button
