      ...
      <el-dropdown trigger="click">
        <div class="flex items-center">
          ...
          <div>
            ...
            <div class="text-xs text-black-600">@{{ currentUser.username }}</div>
          </div>
        </div>
        <el-dropdown-menu slot="dropdown" class="min-w-[200px]">
          ...
          <el-dropdown-item class="text-warning" divided>
            {{ $t('data.admin_menu.team_profile') }}
          </el-dropdown-item>
          <el-dropdown-item class="text-warning">
            {{ $t('data.admin_menu.change_team') }}
          </el-dropdown-item>
