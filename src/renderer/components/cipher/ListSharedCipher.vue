  ...
  asyncComputed: {
    allCiphers: {
      async get () {
        ...
        result = result.filter(cipher => [CipherType.Login, CipherType.SecureNote, CipherType.Card, CipherType.Identity].includes(cipher.type) && cipher.deletedDate == null)
        return result
      },
    ...
    ciphers: {
      ...
      watch: ['allCiphers', 'invitations', 'myShares']
    }
  },
  methods: {
    addEdit (cipher) {
