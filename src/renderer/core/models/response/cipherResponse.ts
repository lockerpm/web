...
import { PasswordHistoryResponse } from '~/jslib/src/models/response/passwordHistoryResponse'
...
export class CipherResponse extends BaseResponse {
  ...
  constructor (response: any) {
    ...
    const cryptoAccount = this.getResponseProperty('CryptoAccount')
    if (cryptoAccount != null) {
      this.cryptoAccount = new CryptoAccountApi(cryptoAccount)
    }
