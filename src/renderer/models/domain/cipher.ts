...
export class Cipher extends Domain {
  ...
  constructor (
    ...
    case CipherType.CryptoAccount:
      this.cryptoAccount = new CryptoAccount(obj.cryptoAccount, alreadyEncrypted)
      break
    default:
      break
    }
  ...
  async decrypt (encKey?: SymmetricCryptoKey): Promise<CipherView> {
    ...
    case CipherType.Login:
      ...
      break
    case CipherType.CryptoAccount:
      model.cryptoAccount = await this.cryptoAccount.decrypt(this.organizationId, encKey)
      break
    case CipherType.SecureNote:
